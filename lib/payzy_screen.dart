...
class _PayzyScreenState extends State<PayzyScreen> {
  ...
  final TextEditingController _procFeeCtrl = TextEditingController(text: '8');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('PayZy Calculator', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white)),
        backgroundColor: const Color(0xFF1F2937),
        elevation: 1,
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            focusedBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(12),
              borderSide: const BorderSide(color: Color(0xFF00AEEF), width: 2), // PayZy blue
            ),
          ),
        ),
      ],
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: [const Color(0xFF00AEEF).withValues(alpha: 0.1), Colors.cyan.withValues(alpha: 0.1)],
                ),
              ...
              children: [
                ...
                if (showResults) ...[
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: _buildInstallmentBox('2 MONTHS', _twoMonths, Colors.lightBlue),
                      ),
                      const SizedBox(width: 8),
                      Expanded(
                        child: _buildInstallmentBox('3 MONTHS', _threeMonths, Colors.cyan),
                      ),
                      const SizedBox(width: 8),
                      Expanded(
                        child: _buildInstallmentBox('4 MONTHS', _fourMonths, Colors.teal),
                      ),
                    ],
                  ),
                  const SizedBox(height: 24),
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor: _showSavedFeedback ? Colors.green : const Color(0xFF00AEEF),
    ...
    return Container(
      ...
      child: Column(
        children: [
          Text(
            title,
            style: TextStyle(fontSize: 10, fontWeight: FontWeight.w600, color: accent.shade300, letterSpacing: 0.5),
            maxLines: 1,
          ...
          Text(
            ...
            style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: accent.shade200),
            maxLines: 1,
            overflow: TextOverflow.ellipsis,
          ),
          ...
          Text(
            '/ month',
            style: TextStyle(fontSize: 10, color: accent.shade300),
          ),
        ],
      ),
    );
                        ...
                        Column(
                          ...
                          children: [
                            Text(
                              ...
                              style: TextStyle(fontSize: 11, fontWeight: FontWeight.w600, color: Colors.lightBlue.shade300),
                            ),
                            const SizedBox(height: 2),
                            Text(
                              '3M: ${_currencyFormat.format(item['threeMonths'])}',
                              style: TextStyle(fontSize: 11, fontWeight: FontWeight.w600, color: Colors.cyan.shade300),
                            ),
                            const SizedBox(height: 2),
                            Text(
                              '4M: ${_currencyFormat.format(item['fourMonths'])}',
                              style: TextStyle(fontSize: 11, fontWeight: FontWeight.w600, color: Colors.teal.shade300),
                            ),
                          ],
                        ),
                      ],
